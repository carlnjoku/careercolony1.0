!function($, wysi) {
	...
	var templates = {
		...
		"lists": 	"<li>" 
						+ "<div class='btn-group'>" 
					    	+ "<a class='btn btn-primary' data-wysihtml5-command='insertUnorderedList' title='Unordered List'><i class='fa fa-list icon-white'></i></a>" 
						    + "<a class='btn btn-primary' data-wysihtml5-command='insertOrderedList' title='Ordered List'><i class='fa fa-th-list icon-white'></i></a>" 
						    + "<a class='btn btn-primary' data-wysihtml5-command='Outdent' title='Outdent'><i class='fa fa-indent icon-white'></i></a>"  							    
						    + "<a class='btn btn-primary' data-wysihtml5-command='Indent' title='Indent'><i class='fa fa-outdent icon-white'></i></a>" 
						+ "</div>" 
					+ "</li>",
