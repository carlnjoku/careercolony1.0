<?php 
class Testanything extends CI_Controller
{
    public $data = array('subview'=>'Sorry you have not subview loaded');
       ...
       public function sendsms($phone, $cleam_message)
	   {

			$phone ='+2348115558473';
 			$msg = 'Sub';
 			$cleam_message = urlencode($msg);
 			$ch = curl_init();
 			//curl_setopt($ch, CURLOPT_URL, "http://31.132.2.43:13013/cgi-bin/sendsms?username=tester&password=foobar&from=5544&to=$phone&text=$cleam_message&smsc=glo1");
 			curl_setopt($ch, CURLOPT_URL, "http://31.132.2.43:13013/sms.php?from=5544&to=$phone&text=$cleam_message&smsc=glo1");
        ...
        function testdrop()
        {
        	...
        	$data['main_content'] = 'start/testdrop';
            $this->load->view('includes/template_a', $data);
        
        }
     
        
        function process_testdrop()
        {
        	$this->load->model('app_model');
 			$result =  $this->app_model->getcountry();
