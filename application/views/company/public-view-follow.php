  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="<?php echo base_url();?>uploads/company_banner/banner4.jpg">
    </div>
    <div class="item">
...
<div class="container-777">
			...
			<div class="row">
				...
				<div class="col-md-8">
					...
					<h4 class="strong" style="margin-bottom:15px">News and Updates</h4>
		...
		<div class="col-md-4">
			<div class="widget  padding-none">
				...
				<h5 class="innerAll bg-primary text-white margin-bottom-none">Current Openings</h5>
