	...
	function limitText(limitField, limitCount, limitNum) {
		...
		<div class="col-md-4">
			<div class="widget  padding-none">
				...
				<h5 class="innerAll bg-primary text-white margin-bottom-none">Manage Company</h5>
				
				<ul class="list-group list-group-1 margin-none borders-none">
					<li class="list-group-item border-top-none"><a href="courses_listing.html?lang=en"><span class="badge pull-right bg-primary ">30</span><i class="fa fa-edit"></i>&nbsp; Edit Page</a></li>
					<li class="list-group-item"><a href="courses_listing.html?lang=en"><span class="badge pull-right bg-primary ">2</span><i class="fa fa-plus"></i>&nbsp; Add Location</a></li>
					<li class="list-group-item"><a href="courses_listing.html?lang=en"><i class="fa fa-plus"></i>&nbsp; Add Photos & Videos</a></li>
