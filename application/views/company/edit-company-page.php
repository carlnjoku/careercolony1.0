                        ...
                        <ul>
                            ...
                            <li id="navigation">
                                <ul style="position:relative; top:20px; left:50px;">
                                    <li><span><a id="home" href="<?php echo base_url();?>company/company_home/<?php echo $this->uri->segment(3);?>" class="text-info"><i class="fa fa-home"></i> Page Home</a></span></li>
                                    <li><span><a id="about" href="javascript:;" class="text-primary"><i class="fa fa-calendar"></i> About Us</a></span></li>
...
<div class="container-777">
    ...
    <div class="widget  padding-none">
				...
				<ul class="list-group list-group-1 margin-none borders-none">
                    ...
                    <li class="list-group-item"><a id="edit_page" href="<?php echo base_url();?>company/edit_company_page/<?php echo $coyID;?>" ><i class="fa fa-pencil"></i>&nbsp; Edit Company Page</a></li>
                    <li class="list-group-item"><a id="edit_page" href="<?php echo base_url();?>company/post_job/<?php echo $coyID;?>" ><i class="fa fa-briefcase"></i>&nbsp; Post a New Job</a></li>
                    <li class="list-group-item"><a id="edit_page" href="<?php echo base_url();?>company/post_event/<?php echo $coyID;?>" ><i class="fa fa-spinner"></i>&nbsp; Post a New Event</a></li>
                </ul>
				</div>
			</div>
...
$(document).ready(function(){
        ...
        var loadUrl = '<?php echo base_url();?>company/edit_company_page_partials/'+coyID;
