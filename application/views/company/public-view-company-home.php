                        ...
                        <ul>
                            ...
                            <li id="navigation">
                                <ul style="position:relative; top:20px; left:50px;">
                                    <li><span><a id="home" href="javascript:;" class="text-info"><i class="fa fa-home"></i> Home</a></span></li>
                                    ...
                                    <li><span><a id="careers" href="javascript:;" class="text-info"><i class="fa fa-briefcase"></i> Careers</a></span></li>
                                </ul>
...
$(document).ready(function(){
        var loadUrl = '<?php echo base_url();?>company/p_home';
