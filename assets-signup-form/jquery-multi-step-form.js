(function($) {
    ...
    $.extend(FORM, {
        ...
        _next: function() {
            // Validate Employment Status and Postal Code
            var ajax_load_employment_status = '<div class="alert alert-danger">Please select an employment status.</div>';
            var ajax_load_postal_code = '<div class="alert alert-danger">Please enter your postal code</div>';
            var ajax_load_country = '<div class="alert alert-danger">Please enter your country</div>';
    		var employment_status = $("#employment_status").val();
    		var postal_code = $("#postal_code").val();
    		var country = $("#country").val();
    		if(country=="" || country==null) {
    			$("#error").html(ajax_load_country).fadeIn("3000"); 
    		}else if(employment_status=="0" || employment_status==null) {
    			$("#error").html(ajax_load_employment_status).fadeIn("3000"); 
    		}else if(postal_code=="" || postal_code==null) {
    			$("#error").html(ajax_load_postal_code).fadeIn("3000"); 
